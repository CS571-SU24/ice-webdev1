...
export default function AllRecipes(props) {
    ...
    useEffect(() => {
        ...
        fetch("https://cs571api.cs.wisc.edu/rest/su24/ice/pasta", {
            headers: {
                "X-CS571-ID": CS571.getBadgerId()
            }
        })
        ...
        fetch("https://cs571api.cs.wisc.edu/rest/su24/ice/chili", {
            headers: {
                "X-CS571-ID": CS571.getBadgerId()
            }
        })
